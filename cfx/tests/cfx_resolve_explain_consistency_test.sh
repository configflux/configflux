...
for v in \
  ...
  HERO_DEFS_RLOCATION HERO_COMPONENTS_RLOCATION \
  IMPLIED_DEFS_RLOCATION IMPLIED_COMPONENTS_RLOCATION \
  LOWERED_CATALOGUE_RLOCATION LOWERED_BINDINGS_RLOCATION \
  LOWERED_COMPONENTS_RLOCATION; do
  require_var "${v}"
done
...
export IMPLIED_DEFS="$(resolve "${IMPLIED_DEFS_RLOCATION}")"
export IMPLIED_COMPONENTS="$(resolve "${IMPLIED_COMPONENTS_RLOCATION}")"
export LOWERED_CATALOGUE="$(resolve "${LOWERED_CATALOGUE_RLOCATION}")"
export LOWERED_BINDINGS="$(resolve "${LOWERED_BINDINGS_RLOCATION}")"
export LOWERED_COMPONENTS="$(resolve "${LOWERED_COMPONENTS_RLOCATION}")"
